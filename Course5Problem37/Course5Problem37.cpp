...
void CopyArrayElementsToOtherArrayUsingAddArrayElement(int Arr1[], int Arr2[], int Array1Length , int& Array2Length)
{
...
int main()
{
	...
	CopyArrayElementsToOtherArrayUsingAddArrayElement(Arr , Arr2 , Length , Length2);
